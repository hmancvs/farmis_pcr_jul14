...
/* $Id: dompdf.php,v 1.1 2012/06/08 13:25:39 gwmubiru Exp $ */
...
switch ( $sapi ) {
 ...
 default:
  ...
  if ( isset($_GET["input_file"]) )
    $file = $working_directory.rawurldecode($_GET["input_file"]);
  else
  ...
  $outfile = time().".pdf"; # Don't allow them to set the output file, but use the current timestamp as a file name 
